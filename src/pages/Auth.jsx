...
import { Shield, Eye, EyeOff, MessageCircle } from 'lucide-react';
    ...
    <div className="auth-page">
      <div className="auth-card animate-in">
        <div className="auth-logo">
          <div className="auth-logo-icon"><MessageCircle size={24} color="white" /></div>
          <h2>ShadowChat</h2>
        </div>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <button className="btn btn-gradient" type="submit" disabled={loading} style={{ width: '100%', padding: '14px', fontSize: '15px' }}>
